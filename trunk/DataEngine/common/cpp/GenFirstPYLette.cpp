...
{  
    ...
    // Unicode转换成MultiByte  
    DWORD dwNum = WideCharToMultiByte(CP_OEMCP,NULL,strName.c_str(),-1,NULL,0,NULL,FALSE);  
    char *psText;  
    ...
    {  
        WideCharToMultiByte (CP_OEMCP,NULL,strName.c_str(),-1,psText,dwNum,NULL,FALSE);  
        strSource = psText;  
        delete []psText;  
    }  
    ...
    // MultiByte转换成Unicode  
    dwNum = MultiByteToWideChar (CP_ACP, 0, strOutput.c_str(), -1, NULL, 0);  
    ...
    {  
        MultiByteToWideChar (CP_ACP, 0, strOutput.c_str(), -1, pwText, dwNum);  
        strResult = pwText;  
        delete [] pwText;  
    }  
