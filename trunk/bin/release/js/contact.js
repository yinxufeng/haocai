	...
	for(var i =0;i<contact.length;i++)
	{
	   switch(contact[i].position){
		 ...
		 case 'I':
		 	...
		 	break;
		 case 'J':
			s+="<div class=\"contact_div1\">J</div>";
			break;
		 case 'K':
			s+="<div class=\"contact_div1\">K</div>";
			break;
		 case 'L':
			s+="<div class=\"contact_div1\">L</div>";
			break;
		 case 'M':
		 	s+="<div class=\"contact_div1\">M</div>";
		 	break;
		 case 'N':
			s+="<div class=\"contact_div1\">N</div>";
			break;
		 case 'O':
...
$(document).ready(function(){
	...
	$("#txt_newgroup").blur(function(){
	   if($(this).val()!="") {
		   ...
		   $("#menu").append("<li><span oncontextmenu='showMenu(this)'>"+$(this).val()+"(0)</span></li>");
