...
void CDlgLianHaoHongQiu::InitListHeader()
{
	...
	m_ListCtrl.InsertColumn(1,_TEXT("围蓝1"),	LVCFMT_CENTER,	2*nWidth);
	m_ListCtrl.InsertColumn(2,_TEXT("围蓝2"),	LVCFMT_CENTER,	2*nWidth+50); 
	m_ListCtrl.InsertColumn(3,_TEXT("围蓝3"),	LVCFMT_CENTER,	2*nWidth); 
	m_ListCtrl.InsertColumn(4,_TEXT("杀蓝1"),	LVCFMT_CENTER,	2*nWidth);
	m_ListCtrl.InsertColumn(5,_TEXT("杀蓝2"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(6,_TEXT("杀蓝3"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(7,_TEXT("杀蓝4"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(8,_TEXT("杀蓝5"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(9,_TEXT("杀蓝6"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(10,_TEXT("杀蓝7"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(11,_TEXT("杀蓝8"),	LVCFMT_CENTER,	nWidth);
	m_ListCtrl.InsertColumn(12,_TEXT("杀蓝9"),	LVCFMT_CENTER,	nWidth);
...
void CDlgLianHaoHongQiu::OnShowWindow(BOOL bShow, UINT nStatus)
{
	...
	if(!m_IsInitData)
	{
		...
		for(int Index = 1; Index < (int)DataList->size()+1; Index++)
		{
			...
			case 5:
				LanQiu8="杀02 04 10 16";
				break;

			case 6:
				LanQiu8="杀05 08 10 12 16";
				break;
