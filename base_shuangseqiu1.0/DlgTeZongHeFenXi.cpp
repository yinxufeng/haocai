...
void CDlgTeZongHeFenXi::OnShowWindow(BOOL bShow, UINT nStatus)
{
	...
	if(!m_IsInitData)
	{
		...
		m_ListCtrl.SetItemText(0,1,_T("篮球在        一页里："));
		m_ListCtrl.SetItemText(0,2,_T("篮球在     一 二页里："));
		m_ListCtrl.SetItemText(0,3,_T("篮球在     一 三页里："));
		m_ListCtrl.SetItemText(0,4,_T("篮球在  一 二 三页里："));
		m_ListCtrl.SetItemText(0,5,_T("篮球不在一 二 三页里："));
		m_ListCtrl.SetItemText(0,6,_T("篮球在        二页里："));
		m_ListCtrl.SetItemText(0,7,_T("篮球在     二 三页里："));
		m_ListCtrl.SetItemText(0,8,_T("篮球在        三页里："));
